		...
		foreach ($resultats as $unResultat) {
			echo "
				<tr> 	<td> ".$unResultat['NOM_M']."</td>
						...
						<td> ".$unResultat['PRIX_M']."</td>
						<td> <a href=\"panier.php?action=ajout&idm=".$unResultat['ID_M']."&libelle=".$unResultat['NOM_M']."&qte=1&prix=".$unResultat['PRIX_M']."\"' onclick=\"window.open(this.href, '',
